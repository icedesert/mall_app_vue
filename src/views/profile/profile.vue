<template>
  <section class="profile">
    ...
    <header class="mui-bar mui-bar-nav head">
      ...
      <h1 class="mui-title headtitle" style="color: #ffffff;">用户页面</h1>
    </header>
    <section class="profile-number" @click="isLogin">
      <router-link class="profile-link" :to="userInfo._id ? '/mine' : '/login'">
        <div class="profile_image">
          <img v-if="userInfo._id" src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1577877236570&di=6421362a33295bfbf9bf86fdf2141c6c&imgtype=0&src=http%3A%2F%2Fimage.uczzd.cn%2F1619940940400645406.jpg%3Fid%3D0"/>
          <i v-else class="iconfont icon-person" style="color: #958a90;"></i>
        </div>
        <div class="user-info">
          <p class="user-info-top">{{userInfo.name || userInfo.phone || '登录/注册'}}</p>
          <p>
                <span class="user-icon">
                  <i class="iconfont icon-shouji icon-mobile phone-icon"></i>
                </span>
